...
class Product:
    ...
    def __init__(self, _id: str, user_id, title: str, images: list, price: float, description: str, category: str, tags: list, salesOffer: str, stock: int, variants: list, weight: str, featured: str, units: int, video: str):
        self._id = _id
        self.user = user_id
        self.title = title
        self.images = images
